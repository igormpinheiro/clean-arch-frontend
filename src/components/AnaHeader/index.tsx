export const AnaHeader = () => {
  return (
    <>
      ...
      <header
        className="br-header mb-4 bg_repeat"
        id="header"
        ...
        <div className="container-lg">
          <div className="header-top">
            <div className="header-logo">
              ...
              <div className="header-sign">Agência Nacional de Águas</div>
            </div>
          ...
          <div className="header-bottom">
            <div className="header-menu">
              ...
              <div className="header-info">
                <div className="header-title">Boleto Online</div>
                <div className="header-subtitle">CNARH Arrecadação</div>
              </div>
            </div>
